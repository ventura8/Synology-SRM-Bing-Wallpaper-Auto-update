...
```sh
wget -qO- https://raw.githubusercontent.com/ventura8/Synology-SRM-Bing-Wallpaper-Auto-update/main/install.sh | sudo sh
```
...
- Non-Markdown files must be 140 characters or fewer per line.
- Markdown line length is not enforced.
